 ...
 * <br>Its intended purpose is to accept a {@link Expression} extending object to convert into a {@link ToStringExpression}.
 *
 * @param <T>
...
public abstract class AbstractUnaryToStringExpression<T extends Expression> implements ToStringExpression{
    ...
    protected AbstractUnaryToStringExpression(T delegate){
        CheckUtil.notNull(delegate, AbstractUnaryToStringExpression.class, "Delegate");
