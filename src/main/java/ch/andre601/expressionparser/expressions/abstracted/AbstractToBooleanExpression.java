 ...
 * <br>Its intended purpose is to accept a Collection of {@link Expression} extending Objects to create a
 * {@link ToBooleanExpression} from.
 *
 * @param <T>
...
public abstract class AbstractToBooleanExpression<T extends Expression> implements ToBooleanExpression{
    ...
    public AbstractToBooleanExpression(Collection<T> operands){
        CheckUtil.notNullOrEmpty(operands, AbstractToBooleanExpression.class, "Operands");
