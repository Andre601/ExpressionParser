 ...
 * <br>Its intended purpose is to accept a {@link Expression} extending object to convert into a {@link ToDoubleExpression}.
 *
 * @param <T>
...
public abstract class AbstractUnaryToDoubleExpression<T extends Expression> implements ToDoubleExpression{
    ...
    protected AbstractUnaryToDoubleExpression(T delegate){
        CheckUtil.notNull(delegate, AbstractUnaryToDoubleExpression.class, "Delegate");
